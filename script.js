    ...
    const poemText = "En este 21 de septiembre quiero regalarte estas flores amarillas,\n" +
        "simbolo de amistad, alegria y buenos deseos.\n" +
        "Que cada petalo te recuerde lo valiosa que eres ali <3,\n" +
        "y lo especial que es tenerte en mi vida,\n\n" +
        "y lo mucho que iluminas con tu sonrisa.\n" +
        "Hoy celebro tu amistad,\n" +
        "Y deseo que la primavera te traiga,\n" +
        "nuevos comienzos llenos de luz, amor y felicidad.";
